...
public class HTTP{
    ...
    public boolean post_sse(String data,EventListenner el){
        String res="";
        try {
            this.h= (HttpURLConnection) this.u.openConnection();
            this.h.setInstanceFollowRedirects(false);
            ...
            while(el.flag(line)){
                line=in.readLine();
                if(line!=null){
                el.onMessageListenner(in.readLine());
                }
                res+=line;
            }
            el.onClosedListenner(res);
            in.close();
            return true;
        } catch (Exception e) {
            this.e=e;
            el.onErrorListenner(e);
            return false;
        }
    }
    ...
    public interface EventListenner{
        public void onMessageListenner(String msg);
        public void onErrorListenner(Exception e);
        public void onClosedListenner(String msg);
        public boolean flag(String msg);
    }
